/*
  ...
  - тезисные планы и доказательства для билетов 1–100 подготовлены в рабочем чате;
  ...
  для отредактированных билетов 54, 55, 64, 69, 72, 76, 77, 80, 85, 86, 87, 92, 98, 99. Автоматическая подстановка для них отключена.
*/
...
const MANUAL_THESIS_EVIDENCE = {
  54: [
    {title:'Декаданс выражает кризисное мироощущение конца XIX века', proof:'Декаданс связан с ощущением культурного истощения, утраты устойчивых ценностей и сомнением в идее общественного прогресса. Для него характерны мотивы усталости, одиночества, болезненной утончённости, искусственности и неприятия буржуазной повседневности. При этом декаданс нельзя считать единым литературным направлением: это более широкое настроение эпохи, проявившееся в символизме, эстетизме и других течениях.'},
    {title:'Символизм превращает кризисное мироощущение в самостоятельную художественную систему', proof:'Символисты считают, что видимая реальность не исчерпывает сущности мира. За вещами, звуками и событиями скрываются духовные связи, которые невозможно передать прямым логическим описанием. Поэтому поэзия должна не объяснять, а внушать, создавать настроение и направлять читателя к самостоятельному постижению скрытого смысла.'},
    {title:'Бодлер является важнейшим предшественником французского символизма', proof:'Бодлер не принадлежал к оформленной символистской школе в том же смысле, что Верлен, Рембо и Малларме, однако именно его поэзия подготовила её эстетику. В стихотворении «Соответствия» природа изображена как храм, наполненный знаками, а запахи, цвета и звуки вступают в перекличку. Эта идея единства чувственного и духовного мира стала одной из основ символистской поэтики.'},
    {title:'Символ отличается от однозначной аллегории', proof:'Аллегория обычно допускает относительно точную расшифровку: конкретный образ соответствует определённой идее. Символ сохраняет смысловую открытость и способен соединять несколько значений одновременно. Туман, музыка, цветок, дорога или вечер могут выражать внутреннее состояние, тайну бытия, воспоминание и предчувствие, не сводясь к одной формуле.'},
    {title:'Поль Верлен утверждает принцип музыкальности и поэтику полутонов', proof:'Для Верлена важны ритм, интонация, звук и изменчивое настроение. В его стихах смысл не формулируется как логический вывод, а возникает из повторов, созвучий и едва заметных эмоциональных переходов. Пейзаж часто становится отражением душевного состояния, однако чувство сохраняет неопределённость и не получает окончательного названия.'},
    {title:'Артюр Рембо превращает поэзию в эксперимент над восприятием и языком', proof:'Рембо стремится разрушить привычную связь между словом и предметом. Он соединяет цвет, звук, движение и телесное ощущение, создавая неожиданные ассоциации. В сонете «Гласные» каждой букве приписывается цвет, благодаря чему язык начинает восприниматься как самостоятельная система видений.'},
    {title:'Стефан Малларме развивает поэтику намёка и смысловой неполноты', proof:'Малларме избегает прямого называния предмета, потому что буквальное обозначение, по его мнению, уничтожает поэтическую тайну. Смысл возникает из пауз, синтаксических разрывов, расположения слов и системы ассоциаций. Читатель должен не получить готовую мысль, а восстановить её из художественной структуры.'},
    {title:'Символистская поэзия меняет роль читателя', proof:'Произведение больше не предлагает единственной окончательной интерпретации. Читатель включается в создание смысла, сопоставляя мотивы, звуки, цвета и повторяющиеся образы. Трудность текста становится не случайным недостатком, а частью художественного метода.'},
    {title:'Французский символизм подготовил поэтику европейского модернизма', proof:'Символисты расширили значение метафоры, музыкальности, ассоциации и многозначного образа. Их открытия повлияли на поэзию, драму и прозу XX века. Особое значение получили фрагментарность, недосказанность, внимание к языку и отказ от прямого изображения действительности.'}
  ],
  55: [
    {title:'Немецкая литература рубежа веков развивается в условиях стремительной модернизации общества', proof:'Объединение Германии, индустриализация, рост городов и усиление социальных конфликтов меняют традиционный уклад. Литература обращается к рабочему движению, кризису буржуазной семьи, отчуждению личности и противоречию между культурой и технической цивилизацией.'},
    {title:'Литературный процесс характеризуется сосуществованием нескольких направлений', proof:'Натурализм, критический реализм, символизм, неоромантизм и ранний модернизм развиваются параллельно и взаимодействуют друг с другом. Один автор может соединять социальную конкретность с философской символикой, а психологический анализ — с гротеском или мифом.'},
    {title:'Натурализм становится важным этапом обновления немецкой литературы', proof:'Натуралисты стремятся изображать действительность с документальной точностью и подчёркивают влияние среды, наследственности и социального положения. В драме особое значение получают бытовая речь, диалект, профессиональная среда и жизнь низших общественных слоёв.'},
    {title:'Герхарт Гауптман соединяет натуралистическую драму с трагическим обобщением', proof:'В пьесе «Ткачи» изображено восстание силезских рабочих. Главным героем становится не отдельная личность, а коллектив, доведённый нищетой до протеста. Реалистическая точность быта соединяется с ощущением исторической катастрофы.'},
    {title:'Критический реализм обращается к кризису буржуазной культуры', proof:'Писатели исследуют разрыв между внешней респектабельностью и внутренним нравственным распадом. Семья, собственность, образование и культура перестают быть устойчивыми опорами. Этот конфликт особенно важен в творчестве Генриха и Томаса Маннов.'},
    {title:'Генрих Манн развивает социально-политическую сатиру', proof:'В романе «Верноподданный» Дидерих Геслинг строит карьеру на покорности сильным и жестокости к слабым. Он преклоняется перед императорской властью, использует националистическую риторику и превращает общественные идеалы в средство личного продвижения. Частный характер становится сатирическим образом вильгельмовской Германии.'},
    {title:'Томас Манн исследует противоречие художника и бюргерского мира', proof:'В «Будденброках» упадок семьи связан не только с экономическими причинами, но и с усилением рефлексии и художественной чувствительности. В новелле «Тонио Крёгер» герой разрывается между искусством и тягой к обычной человеческой жизни. Писатель не принимает полностью ни холодный эстетизм, ни духовно ограниченную бюргерскую норму.'},
    {title:'В немецкоязычной литературе усиливаются символистские и неоромантические тенденции', proof:'Наряду с реалистическим изображением литература обращается к символу, мифу, легенде, сну и философскому образу. Здесь важно разграничивать собственно литературу Германии и более широкое немецкоязычное пространство. Так, австрийский поэт Райнер Мария Рильке принадлежит именно к немецкоязычной литературе и развивает темы одиночества, смерти, вещи и духовного преображения.'},
    {title:'Рубеж веков подготавливает немецкоязычный модернизм', proof:'Кризис личности, ненадёжность привычных ценностей и внимание к внутреннему сознанию создают основу для дальнейшего творчества Кафки, Гессе, Музиля и других писателей XX века. Литература всё чаще изображает мир как непостижимую и противоречивую систему.'}
  ],
  64: [
    {title:'Творчество Киплинга формируется на пересечении английской и индийской культур', proof:'Киплинг родился в Индии, долго жил там и хорошо знал колониальный быт, языковую среду, армию и жизнь разных социальных групп. Индия в его произведениях не является только экзотическим фоном. Она становится сложным миром, где сталкиваются культуры, религии, власть и личный опыт.'},
    {title:'Писатель сочетает интерес к империи с вниманием к человеку службы', proof:'Героями Киплинга часто становятся солдаты, инженеры, чиновники, врачи и люди, выполняющие тяжёлую работу на окраинах империи. Он ценит дисциплину, профессионализм, товарищество и способность отвечать за дело. Именно эти качества формируют его этический идеал.'},
    {title:'Имперское мировоззрение Киплинга внутренне противоречиво', proof:'Писатель нередко воспринимает британскую власть как естественную организующую силу и разделяет многие представления своей эпохи о «цивилизаторской миссии». Одновременно он показывает сложность Индии, ограниченность колониальных чиновников и нравственную неоднозначность имперского служения. Поэтому его творчество нельзя сводить ни к простой апологии империи, ни к последовательной антиколониальной критике.'},
    {title:'Проза Киплинга строится на точном знании среды и профессиональной речи', proof:'В рассказах важны детали формы, оружия, службы, дороги, климата и местных обычаев. Персонажи говорят по-разному в зависимости от происхождения и профессии. Такая речевая и бытовая точность создаёт убедительность и позволяет показать общественную иерархию без длинных авторских объяснений.'},
    {title:'«Ким» соединяет приключенческий роман, роман воспитания и колониальную панораму', proof:'Ким растёт на улицах Лахора, свободно переходит между культурами и не принадлежит полностью ни одной из них. Его путешествие с тибетским ламой связано с духовным поиском, а участие в «Большой игре» — с политикой и разведкой. Роман строится на двойном движении: герой осваивает мир империи и одновременно ищет собственную идентичность.'},
    {title:'Образ Кима показывает сложность культурной принадлежности', proof:'Ким является ирландцем по происхождению, но вырос в индийской среде и воспринимает её как родную. Он способен менять язык, одежду и социальную роль. Такая подвижность даёт ему свободу, но одновременно ставит вопрос о том, к какому миру он принадлежит в действительности.'},
    {title:'«Книга джунглей» изображает воспитание через закон сообщества', proof:'Маугли растёт среди волков и учится Закону джунглей, который регулирует отношения животных. Этот закон требует дисциплины, знания границ и взаимной ответственности. Герой становится сильным не только благодаря природным способностям, но и благодаря усвоению правил, позволяющих разным существам сосуществовать.'},
    {title:'Образ Маугли раскрывает конфликт принадлежности и одиночества', proof:'Маугли связан и с миром животных, и с людьми, но не может полностью раствориться ни в одном из них. Его изгнание из стаи и трудное возвращение к человеческому обществу показывают цену двойной идентичности. Свобода героя сопровождается внутренней бездомностью.'},
    {title:'Поэзия Киплинга соединяет балладность, песенность и разговорную интонацию', proof:'Его стихи часто строятся на повторе, чётком ритме, рефрене и голосе конкретного персонажа. Военные и казарменные песни передают речь простого солдата, а не только официальную имперскую риторику. Благодаря этому поэзия приобретает драматический и повествовательный характер.'},
    {title:'Стихотворение «Если…» выражает этический идеал самообладания', proof:'Лирическое наставление строится на способности сохранять внутреннюю устойчивость в успехе и поражении, не подчиняться ни самодовольству, ни отчаянию. Главной добродетелью становится не внешняя победа, а власть над собой, терпение и верность избранному пути.'},
    {title:'Современное прочтение Киплинга требует постколониальной критической дистанции', proof:'Художественная точность, внимание к индийской культуре и сложность образов не отменяют того, что тексты создавались внутри британского имперского сознания. Поэтому важно одновременно оценивать литературное мастерство автора и анализировать те представления о культурной и политической иерархии, которые отражены в его произведениях.'}
  ],
  69: [
    {title:'Первая мировая война разрушила прежние представления о прогрессе и героике', proof:'До войны европейская культура часто связывала развитие техники, науки и государства с движением к лучшему будущему. Массовая гибель, применение пулемётов, артиллерии, авиации и химического оружия показали, что технический прогресс может служить уничтожению. В литературе война всё реже изображается как пространство славы и всё чаще — как система бессмысленного насилия.'},
    {title:'Главным объектом изображения становится опыт рядового солдата', proof:'Писатели сосредоточиваются на человеке, который испытывает страх, голод, холод, усталость и потерю товарищей. Историческая панорама уступает место телесному и психологическому опыту. Война раскрывается снизу — через окоп, госпиталь, марш, грязь и ожидание смерти.'},
    {title:'Возникает конфликт между официальной риторикой и реальным опытом фронта', proof:'Пропаганда говорит о долге, чести и национальном величии, тогда как солдат видит случайную смерть и бессмысленность приказов. Литература разоблачает высокий язык, который скрывает действительное содержание войны. Отсюда особая роль иронии, сдержанности и конкретной детали.'},
    {title:'Английская фронтовая поэзия разрушает героический миф о войне', proof:'Уилфред Оуэн изображает физическое страдание солдат и разоблачает представление о прекрасной смерти за родину. В стихотворении «Dulce et Decorum Est» газовая атака показана как мучительная и хаотическая гибель, а античная формула о сладости смерти за отечество называется ложью. Зигфрид Сассун соединяет фронтовое свидетельство с сатирой на генералов, тыловое общество и патриотическую риторику.'},
    {title:'Поэзия Гийома Аполлинера соединяет военный опыт с модернистским экспериментом', proof:'Аполлинер воспринимает войну одновременно как историческую катастрофу и как новый, страшный опыт современности. В его стихах фронтовые впечатления соединяются с монтажом, визуальной формой и неожиданными образами. Это показывает, что война меняет не только тематику, но и сам язык поэзии.'},
    {title:'Мотив утраты поколения становится одним из центральных', proof:'Молодые люди уходят на фронт до того, как успевают сформировать мирную биографию. После возвращения они не могут продолжить прежнюю жизнь, потому что их опыт непонятен тем, кто остался в тылу. Война разрушает не только тела, но и способность верить в устойчивые ценности.'},
    {title:'Фронтовое товарищество противопоставляется государству и идеологии', proof:'Солдатская солидарность возникает из общей опасности, а не из политических лозунгов. Товарищ становится важнее отвлечённой национальной идеи. В произведениях Ремарка и Хемингуэя именно человеческая близость временно защищает героя от обезличивающей военной машины.'},
    {title:'Антивоенная литература показывает универсальность человеческого страдания', proof:'Солдаты противоборствующих армий изображаются как люди, оказавшиеся в одинаковой ситуации. В романе Ремарка «На Западном фронте без перемен» Пауль Боймер, оказавшись в воронке рядом с умирающим французским солдатом, понимает, что убил человека с именем, семьёй и собственной жизнью. Образ врага перестаёт быть отвлечённым.'},
    {title:'Война меняет художественную форму', proof:'Линейное и торжественное повествование оказывается недостаточным для передачи травматического опыта. Писатели используют фрагментарность, монтаж, обрывочные воспоминания, повторы и внутренний монолог. Разрушенная композиция соответствует разрушенному сознанию и распаду привычной картины мира.'},
    {title:'Литература о войне развивается в разных художественных направлениях', proof:'Реализм и натурализм передают материальную правду фронта, экспрессионизм усиливает образ катастрофы и обезличивания, модернизм исследует память и травму. Различие методов не отменяет общего стремления заново определить ценность человеческой жизни.'},
    {title:'Первая мировая война становится границей между культурными эпохами', proof:'После войны европейская литература уже не может полностью восстановить прежнюю уверенность в порядке, разуме и нравственном авторитете цивилизации. Темы отчуждения, исторической катастрофы, утраченного поколения и кризиса личности определяют значительную часть литературы XX века.'}
  ],
  72: [
    {title:'Литература социалистической ориентации связывает искусство с анализом общественной несправедливости', proof:'Писатели рассматривают бедность, войну, эксплуатацию и классовое неравенство не как отдельные несчастья, а как следствие устройства общества. Литература должна не только изображать страдание, но и раскрывать его исторические и социальные причины.'},
    {title:'Центральным становится образ коллектива', proof:'Вместо исключительного героя на первый план выходят рабочие, солдаты, участники забастовок и революционных движений. Личность раскрывается через её отношение к другим и готовность участвовать в общем деле. Коллектив может становиться самостоятельным действующим лицом произведения.'},
    {title:'Анри Барбюс приходит к социалистическим взглядам через опыт Первой мировой войны', proof:'Роман «Огонь» основан на фронтовых наблюдениях автора. Солдаты показаны как обычные люди разных профессий и характеров, которых объединяют грязь, страх и угроза смерти. Война постепенно понимается ими как результат политических и экономических интересов, чуждых самим участникам.'},
    {title:'Документальность «Огня» соединяется с идейным обобщением', proof:'Бытовые подробности окопа, разговорная речь, голод и физическое истощение создают ощущение свидетельства. Однако отдельный фронтовой эпизод ведёт к более широкому выводу о необходимости изменить общество, которое превращает людей в материал войны.'},
    {title:'Барбюс связывает антивоенный протест с идеей коллективного действия', proof:'Солдаты постепенно осознают общность своего положения и понимают, что личное спасение невозможно без изменения общественной системы. Поэтому антивоенная тема в его творчестве переходит в революционную и социалистическую проблематику.'},
    {title:'Ромен Роллан сближается с литературой социалистической ориентации через интернациональный гуманизм', proof:'Роллана нельзя полностью сводить к партийной или революционно-социалистической эстетике. Основой его позиции остаётся гуманизм, защита культурного единства Европы и нравственная независимость личности. Однако его антивоенная деятельность, интерес к общественному освобождению и критика буржуазного индивидуализма сближают его с левыми идеями.'},
    {title:'Роллан утверждает нравственную ответственность интеллигенции', proof:'В годы национальной вражды художник, по его убеждению, должен сохранять верность правде и человеческой солидарности. Позиция «над схваткой» означает не безразличие, а отказ подчинять нравственную оценку национальной пропаганде.'},
    {title:'«Жан-Кристоф» соединяет судьбу художника и европейскую историю', proof:'Музыкант Жан-Кристоф проходит через личные кризисы, конфликты с обществом и знакомство с разными национальными культурами. Его творчество становится способом преодоления границ и вражды. Искусство связывается с нравственным служением человечеству.'},
    {title:'В более позднем творчестве Роллана усиливается интерес к революционной истории', proof:'В цикле «Очарованная душа» и общественной деятельности писателя возрастает внимание к социальному освобождению, массовому движению и ответственности личности перед историей. Однако даже здесь Роллан сохраняет самостоятельную гуманистическую позицию и не растворяет человека в политической доктрине.'},
    {title:'Литература социалистической ориентации сочетает реализм и публицистичность', proof:'Социальная среда и исторический конфликт изображаются конкретно, но авторская позиция часто выражена открыто. Повествование может включать политическое рассуждение, документ, обращение и призыв. Это отличает такую литературу от эстетики безличного автора.'},
    {title:'Идейная направленность создаёт и художественные возможности, и опасность схематизма', proof:'Ясная общественная позиция позволяет раскрывать массовую историю и связь личности с системой. Однако при подчинении персонажа готовой доктрине характер может превратиться в иллюстрацию. Наиболее значительные произведения сохраняют внутренние противоречия героя и сложность исторического выбора.'}
  ],
  76: [
    {title:'Ивлин Во изображает современное общество как мир разрушенных ценностей', proof:'В его романах традиционные понятия образования, чести, семьи, религии и общественной службы сохраняют внешнюю форму, но утрачивают внутреннее содержание. Персонажи продолжают соблюдать правила приличия, хотя их поступки определяются выгодой, скукой и равнодушием.'},
    {title:'Сатира Во строится на столкновении наивного героя и абсурдного общества', proof:'Герой нередко пытается действовать разумно, однако окружающий мир воспринимает нормальное поведение как странность. В романе «Упадок и разрушение» Пол Пеннифезер случайно оказывается исключённым из университета, после чего его жизнь начинает зависеть от нелепых решений и чужих прихотей.'},
    {title:'Общество у Во действует по логике случайности и социального произвола', proof:'Карьера, репутация и даже свобода героя зависят не от заслуг, а от совпадений, знакомств и положения в обществе. Пол может мгновенно потерять место, попасть в тюрьму, а затем вернуться к прежней жизни. Случайность разоблачает иллюзию разумного и справедливого устройства мира.'},
    {title:'Спокойная повествовательная интонация усиливает сатирический эффект', proof:'Нелепые и жестокие события описываются без патетики, словно являются обычной частью светской жизни. Рассказчик не выражает прямого возмущения, поэтому безразличие общества становится особенно заметным. Чем спокойнее тон, тем резче ощущается нравственный абсурд.'},
    {title:'Социальные институты изображаются как механизмы, не выполняющие заявленной функции', proof:'Школа не воспитывает, университет не защищает знания, суд не устанавливает справедливость, а пресса не сообщает правду. Каждый институт заботится прежде всего о собственной репутации и существовании. Человек должен приспосабливаться не к смыслу закона, а к процедуре.'},
    {title:'Роман «Сенсация» раскрывает механизм производства новостей', proof:'Из-за редакционной ошибки неопытного Уильяма Бутта отправляют военным корреспондентом в африканскую страну. Газете важнее получить эффектный материал, чем понять реальную политическую ситуацию. Новость создаётся не как отражение события, а как товар, рассчитанный на ожидания читателя.'},
    {title:'Сатирические персонажи напоминают социальные маски', proof:'Во намеренно подчёркивает одну доминирующую черту: карьеризм, праздность, самодовольство или профессиональную некомпетентность. Однако гротескный персонаж не выпадает из реальности. Его поведение оказывается нормальным внутри общества, где статус и маска важнее личности.'},
    {title:'Ранние романы Во разоблачают современность через гротеск и фарс', proof:'«Упадок и разрушение», «Мерзкая плоть» и «Сенсация» строятся на стремительной смене событий, случайностях и резких поворотах. Герой не успевает осмыслить происходящее, а общество предстаёт как бесконечный светский спектакль, лишённый устойчивого нравственного центра.'},
    {title:'«Возвращение в Брайдсхед» показывает эволюцию Во от чистой сатиры к ностальгической и религиозной прозе', proof:'В этом романе ирония сохраняется, но уже не определяет всю художественную систему. Автор обращается к памяти, вере, исчезающему аристократическому миру и духовному поиску. Поэтому «Возвращение в Брайдсхед» нельзя считать типичным сатирическим романом раннего Во: это свидетельство усложнения его мировоззрения.'},
    {title:'Сатира Во не предлагает простой программы исправления общества', proof:'Герои редко способны изменить окружающий порядок. Они приспосабливаются, уходят в частную жизнь или снова включаются в тот же механизм. Писатель фиксирует устойчивость общественного абсурда и ограниченность индивидуального сопротивления.'}
  ],
  77: [
    {title:'Английская литература 1920-х годов отказывается от традиционной реалистической модели', proof:'Последовательный сюжет, всезнающий рассказчик и подробная социальная биография уже не воспринимаются как достаточные средства изображения человека. Писатели обращаются к внутреннему времени, телесному опыту, фрагментарному сознанию и интеллектуальному эксперименту.'},
    {title:'Общим объектом исследования становится кризис современной личности', proof:'Герой ощущает отчуждение от общества, собственных чувств и природной жизни. Внешнее благополучие не устраняет внутренней пустоты. Первая мировая война, механизация и массовая культура усиливают ощущение разрыва между человеком и миром.'},
    {title:'Вирджиния Вулф переносит центр романа во внутреннее сознание', proof:'Внешнее событие у неё может занимать один день, но включает множество воспоминаний, ассоциаций и точек зрения. В романе «Миссис Дэллоуэй» подготовка к вечернему приёму соединяется с переживаниями Клариссы, Септимуса и других персонажей.'},
    {title:'Поток сознания воспроизводит нелинейное движение мысли', proof:'Настоящее постоянно вызывает прошлое, одна деталь переключает внимание на другое время, а сознания разных героев незаметно сменяют друг друга. Повествование показывает не готовую мысль, а сам процесс её возникновения.'},
    {title:'Время у Вулф имеет одновременно внешний и внутренний характер', proof:'Бой Биг-Бена отмечает объективное движение дня, но каждый персонаж переживает этот день по-своему. Несколько секунд могут вместить десятилетия памяти. Внешний городской ритм соединяется с индивидуальной биографией.'},
    {title:'Образ Септимуса раскрывает послевоенную травму', proof:'Септимус возвращается с фронта и не способен восстановить нормальную связь с миром. Его видения и эмоциональное оцепенение врачи воспринимают как отклонение, которое следует подавить. Параллель между ним и Клариссой показывает скрытую близость внешне благополучной жизни и внутреннего чувства смерти.'},
    {title:'Олдос Хаксли развивает интеллектуальный и сатирический роман 1920-х годов', proof:'В «Жёлтом Кроме» писатель создаёт замкнутое общество, где персонажи воплощают разные интеллектуальные, эстетические и научные позиции. Их разговоры раскрывают духовную усталость и самоизоляцию образованной элиты. Сюжет уступает место ироническому столкновению идей.'},
    {title:'«Контрапункт» обновляет композицию романа по музыкальному принципу', proof:'Несколько сюжетных линий и мировоззренческих голосов развиваются одновременно, подобно партиям в музыкальном произведении. Персонажи не подчинены единому авторскому выводу. Композиция передаёт множественность и разобщённость современного сознания.'},
    {title:'Сатира Хаксли направлена против духовной специализации и интеллектуального самообмана', proof:'Его герои нередко обладают развитым умом, но оказываются эмоционально беспомощными. Научная, философская или эстетическая система не даёт им цельности. Интеллект превращается в средство бегства от жизни.'},
    {title:'Роман «О дивный новый мир» продолжает эти поиски уже в следующем десятилетии', proof:'Антиутопия 1932 года не относится непосредственно к литературе 1920-х годов, поэтому не должна служить основным примером этого билета. Однако она продолжает темы, сформировавшиеся в ранней прозе Хаксли: духовную стандартизацию, власть массовой культуры и конфликт свободы с социальной стабильностью.'},
    {title:'Лоуренс противопоставляет рациональной цивилизации телесную и эмоциональную целостность', proof:'Он показывает человека как существо, чья жизнь определяется не только сознательными решениями, но и телом, желанием, природным ритмом. Подавление чувственности ведёт к агрессии, отчуждению и внутреннему распаду.'},
    {title:'Семейный и любовный конфликт у Лоуренса получает философское значение', proof:'В романе «Сыновья и любовники» сильная связь Пола Морела с матерью затрудняет его отношения с другими женщинами. Психологический конфликт связан с классовой средой, семейной властью и неспособностью героя обрести самостоятельную эмоциональную жизнь.'},
    {title:'Три автора предлагают разные способы обновления романа', proof:'Вулф исследует поток сознания и субъективное время, Хаксли строит интеллектуальный полифонический роман, Лоуренс раскрывает телесность и глубинные эмоциональные связи. Их объединяет отказ сводить человека к внешней социальной биографии.'}
  ],
  80: [
    {title:'Американская мечта связывает личный успех со свободой и собственными усилиями', proof:'Согласно этому представлению, человек независимо от происхождения может добиться богатства, признания и высокого положения. Драйзер проверяет этот идеал на материале реального общества и показывает, что возможности распределены неравномерно, а успех зависит от денег, среды, связей и случая.'},
    {title:'Герой Драйзера формируется под сильным воздействием социальной среды', proof:'Желания персонажа возникают не изолированно. Реклама, городская роскошь, богатые дома и общественное уважение учат его связывать счастье с материальным обладанием. Человек стремится не просто к достатку, а к тому образу жизни, который общество объявляет доказательством ценности.'},
    {title:'«Американская трагедия» показывает превращение мечты об успехе в нравственную катастрофу', proof:'Клайд Гриффитс вырос в бедной религиозной семье и стыдится своего происхождения. Он хочет богатства, красивой жизни и принадлежности к высшему кругу. Его стремление понятно, но он усваивает общественную формулу успеха без внутренней нравственной опоры.'},
    {title:'Город создаёт иллюзию безграничных возможностей', proof:'Работа в гостинице открывает Клайду мир денег, развлечений и внешней свободы. Он видит, что социальное положение определяет отношение окружающих. Город обещает движение вверх, но одновременно усиливает зависимость человека от потребления и чужого мнения.'},
    {title:'Любовный конфликт раскрывает социальную природу выбора героя', proof:'Роберта Олден связана с Клайдом реальными отношениями и общей ответственностью, тогда как Сондра Финчли воплощает богатство, статус и желанное будущее. Клайд выбирает не только между двумя женщинами, но и между двумя социальными мирами.'},
    {title:'Преступление возникает из соединения личной слабости и общественного давления', proof:'Клайд не является холодным профессиональным преступником. Он колеблется, фантазирует и избегает прямого решения. Однако его нерешительность не снимает ответственности: он допускает гибель Роберты, потому что ставит собственную мечту о статусе выше её жизни.'},
    {title:'Суд превращает личную трагедию в общественное зрелище', proof:'Политики, адвокаты и пресса используют дело Клайда для карьеры и сенсации. Общество осуждает героя, но не исследует ценности, которые сформировали его желания. Суд наказывает отдельного человека, оставляя без изменения систему поклонения успеху и богатству.'},
    {title:'Натуралистический метод подчёркивает зависимость личности от обстоятельств', proof:'Драйзер подробно показывает происхождение, воспитание, труд, экономическую зависимость и психологические колебания героя. Судьба Клайда складывается из множества причин. Однако детерминизм не уничтожает нравственную проблему: человек обусловлен средой, но всё же совершает выбор.'},
    {title:'Поздние романы расширяют критику индивидуалистической модели успеха', proof:'В «Оплоте» Драйзер обращается к религиозно-нравственному сознанию американского буржуа и показывает, как внешняя добропорядочность сталкивается с реальной властью денег, семейными противоречиями и общественным лицемерием. Устойчивый моральный кодекс не спасает героя от внутреннего кризиса.'},
    {title:'«Стоик» завершает тему финансового могущества и личной несвободы', proof:'Фрэнк Каупервуд достигает исключительного влияния и богатства, но его жизненный путь не приводит к нравственной цельности. Власть капитала расширяет возможности действия, однако не устраняет одиночество, зависимость от страстей и конечность человеческой жизни.'},
    {title:'Эволюция Драйзера ведёт от индивидуальной карьеры к критике общественной системы', proof:'В ранних и центральных романах писатель показывает сильную личность, стремящуюся к успеху, а в позднем творчестве всё яснее раскрывает ограниченность индивидуального восхождения. Богатство отдельного человека не решает проблему свободы, если общество построено на неравенстве и власти капитала.'},
    {title:'Американская мечта у Драйзера сохраняет трагическую двойственность', proof:'Стремление выйти из бедности и самостоятельно построить жизнь обладает человеческой привлекательностью. Трагедия начинается тогда, когда свобода отождествляется только с деньгами и престижем. Мечта, лишённая нравственного содержания, превращает другого человека в средство или препятствие.'}
  ],
  85: [
    {title:'Вторая мировая война и Холокост радикально изменили представление о европейской цивилизации', proof:'Культура, наука и образование не смогли предотвратить массовое уничтожение людей. Поэтому послевоенная литература подвергает сомнению веру в разумный прогресс, гуманистическую устойчивость и нравственное превосходство Запада.'},
    {title:'Опыт катастрофы становится проблемой памяти и свидетельства', proof:'Писатели стремятся сохранить личный опыт жертв, заключённых, солдат и изгнанников. В произведениях Примо Леви документальная точность и сдержанность становятся формой нравственного свидетельства. Литература должна сохранить факт преступления, не превращая страдание в эффектное зрелище.'},
    {title:'Немецкая литература обращается к теме вины и непреодолённого прошлого', proof:'Генрих Бёлль показывает, что военное поражение не означает автоматического нравственного очищения общества. Гюнтер Грасс использует гротеск и ненадёжное повествование, чтобы раскрыть механизм забвения и самооправдания. Прошлое продолжает действовать в семье, языке и общественных институтах.'},
    {title:'Экзистенциализм выражает послевоенное ощущение свободы и ответственности', proof:'В прозе Сартра и Камю человек оказывается в мире без заранее гарантированного смысла. Он не может полностью переложить ответственность на историю, религию или общество. Смысл создаётся поступком, а свобода переживается не только как право, но и как тяжёлое бремя выбора.'},
    {title:'Театр абсурда показывает кризис языка и коммуникации', proof:'В пьесах Беккета и Ионеско персонажи говорят, но не достигают взаимопонимания; повторяют привычные фразы и ожидают события, которое не наступает. Разрушение диалога отражает духовную дезориентацию послевоенного человека.'},
    {title:'Холодная война усиливает политическую тревогу', proof:'Мир разделяется на противостоящие идеологические блоки, а ядерное оружие создаёт возможность глобального уничтожения. Литература обращается к тоталитаризму, пропаганде, манипуляции сознанием и страху перед будущим.'},
    {title:'Деколонизация меняет границы западного литературного канона', proof:'Освобождение колоний ставит вопрос о последствиях империализма, культурной зависимости и праве народов говорить от собственного имени. В литературу входят голоса мигрантов, бывших колониальных народов и людей с двойной культурной идентичностью.'},
    {title:'Массовое общество становится объектом критики', proof:'Развитие телевидения, рекламы и потребления создаёт стандартизированные желания и модели поведения. Литература исследует, как комфорт и товарное изобилие могут сочетаться с одиночеством, конформизмом и потерей индивидуальности.'},
    {title:'«Новый роман» ставит под сомнение традиционную форму повествования', proof:'Натали Саррот и Ален Роб-Грийе отказываются от цельного героя, линейного сюжета и всезнающего рассказчика. Личность раскрывается как поток реакций, а предметный мир получает самостоятельное значение. Кризис доверия к готовой истине отражается в самой структуре романа.'},
    {title:'Постмодернистская проза усиливает недоверие к единственной версии истории', proof:'Фаулз, Эко, Пинчон и другие авторы используют интертекстуальность, иронию и множественные финалы. История понимается как система конкурирующих текстов и интерпретаций. Читатель должен самостоятельно оценивать версии прошлого.'},
    {title:'Послевоенная литература сохраняет поиск человеческой опоры', proof:'Несмотря на кризис универсальных систем, писатели обращаются к личной ответственности, памяти, любви, солидарности и защите другого человека. У Камю доктор Риэ борется с чумой не потому, что уверен в окончательной победе, а потому, что считает необходимым уменьшать страдание.'}
  ],
  86: [
    {title:'Постмодернизм возникает как культура недоверия к универсальным объяснениям', proof:'История XX века показала, что идеи прогресса, нации, разума и общественного освобождения могут использоваться для насилия. Постмодернистская литература ставит под сомнение возможность одной окончательной истины и подчёркивает множественность интерпретаций.'},
    {title:'Мир воспринимается как пространство уже существующих текстов', proof:'Писатель не начинает с абсолютно нового материала, а работает с мифами, литературными сюжетами, жанрами, цитатами и массовой культурой. Произведение становится диалогом с предшествующей традицией.'},
    {title:'Интертекстуальность является основным принципом поэтики', proof:'Текст содержит прямые и скрытые цитаты, аллюзии, стилизации и переработанные сюжеты. Читатель одновременно воспринимает новую историю и узнаёт культурный источник, который получает иной смысл.'},
    {title:'Ирония препятствует окончательному утверждению одной позиции', proof:'Автор может использовать жанр детектива, исторического романа или любовной истории и одновременно показывать его условность. Ирония не обязательно уничтожает серьёзность темы, но не позволяет превратить её в бесспорную догму.'},
    {title:'Метапроза раскрывает процесс создания произведения', proof:'Рассказчик обсуждает выбор сюжета, обращается к читателю, предлагает несколько финалов или признаёт невозможность восстановить события. Роман говорит не только о мире, но и о том, как этот мир создаётся повествованием.'},
    {title:'Смешение высокой и массовой культуры разрушает жанровую иерархию', proof:'Философская проблема может раскрываться через детектив, фантастику, комикс или приключение. Цитаты из классики соседствуют с рекламой, песней и газетой. Постмодернизм отказывается признавать одну культурную форму безусловно высшей.'},
    {title:'История понимается как текст, доступный через версии', proof:'Писатель не может непосредственно вернуть прошлое и работает с документами, свидетельствами и культурными образами. Поэтому исторический роман подчёркивает неполноту знания и зависимость прошлого от способа рассказа.'},
    {title:'Борхес является важнейшим предшественником постмодернизма', proof:'Его рассказы о лабиринтах, бесконечных библиотеках, вымышленных книгах и множественном авторстве предвосхищают интертекстуальность и метапрозу. Однако точнее называть Борхеса предшественником и интеллектуальным источником постмодернизма, а не безоговорочно включать его в зрелое направление второй половины XX века.'},
    {title:'Роман Фаулза «Женщина французского лейтенанта» соединяет викторианский сюжет и современную рефлексию', proof:'Повествователь комментирует нормы XIX века, нарушает иллюзию всезнания и предлагает несколько финалов. Историческая история одновременно рассказывается и анализируется с позиции более поздней культуры.'},
    {title:'Умберто Эко соединяет интеллектуальную игру с массовым жанром', proof:'«Имя розы» использует форму монастырского детектива, но включает философские споры, средневековую семиотику и размышление о власти над знанием. Детективная разгадка не устраняет многозначности произведения.'},
    {title:'Итало Кальвино раскрывает условность самого процесса чтения', proof:'В романе «Если однажды зимней ночью путник» читатель становится персонажем, который постоянно начинает новые книги и не может завершить ни одну. Произведение превращает чтение в сюжет и показывает, как желание целостности сталкивается с бесконечностью текстов.'},
    {title:'К характерным представителям постмодернизма относятся Эко, Кальвино, Фаулз, Пинчон и другие', proof:'Их объединяют текстовая игра, интертекстуальность, проблематизация истины и смешение жанров. При этом национальные модели различаются: у Эко сильна историко-семиотическая линия, у Фаулза — проблема свободы и авторской власти, у Пинчона — энтропия, паранойя и массовая культура.'},
    {title:'Постмодернизм не сводится к бессодержательной игре', proof:'Цитатность и ирония могут служить осмыслению памяти, власти, войны и исторической травмы. Игра показывает не отсутствие реальности, а трудность говорить о ней языком, который уже сформирован культурой и идеологией.'}
  ],
  87: [
    {title:'Сартр и Камю обращаются к человеку, оказавшемуся в мире без заранее гарантированного смысла', proof:'Их герои не могут опереться на готовую религиозную, общественную или историческую систему, которая автоматически объяснила бы существование. Человек вынужден сам определять отношение к миру и отвечать за собственные поступки. Философская проблема раскрывается через конкретную жизненную ситуацию, а не через отвлечённый трактат.'},
    {title:'В философии Сартра существование предшествует сущности', proof:'Человек не получает при рождении окончательно заданной природы. Он создаёт себя решениями и поступками. Происхождение, профессия и общественная роль влияют на него, но не снимают личной ответственности за то, кем он становится.'},
    {title:'Роман Сартра «Тошнота» превращает философскую идею в телесное переживание', proof:'Антуан Рокантен внезапно начинает воспринимать привычные вещи вне их названий и функций. Корень каштана перестаёт быть понятным предметом и открывается ему как бесформенное, избыточное существование. Философская категория случайности бытия переживается героем физически — как тошнота.'},
    {title:'Обыденный язык скрывает случайность и необязательность существования', proof:'Названия, профессии и общественные привычки создают ощущение устойчивого порядка. Рокантен понимает, что вещи и человек могли бы не существовать и не имеют заранее предписанного назначения. Язык временно упорядочивает реальность, но не устраняет её фундаментальной случайности.'},
    {title:'Свобода у Сартра неотделима от ответственности', proof:'Даже отказ от действия является выбором. Человек не может полностью оправдаться приказом, ролью или обстоятельствами, поскольку сам принимает решение подчиниться им. Свобода поэтому переживается не как лёгкое освобождение, а как тяжёлая необходимость постоянно выбирать.'},
    {title:'Понятие «дурной веры» раскрывает механизм самообмана', proof:'Человек может изображать себя полностью определённым социальной ролью и утверждать, что не имеет выбора. Тем самым он скрывает от себя собственную свободу. В художественных произведениях Сартра персонаж часто пытается переложить ответственность на характер, общество или обстоятельства, но именно это становится формой нравственного уклонения.'},
    {title:'Камю традиционно рассматривается рядом с экзистенциализмом, хотя сам не принимал это определение', proof:'Его творчество связано с темами свободы, смерти, одиночества и отсутствия готового смысла, поэтому оно входит в общий контекст экзистенциальной литературы. Однако центральные категории Камю — абсурд, бунт, мера и солидарность. Это отличает его позицию от философской системы Сартра.'},
    {title:'Абсурд у Камю возникает из столкновения человеческой потребности в смысле с молчанием мира', proof:'Человек стремится к ясности, справедливости и объяснению, но действительность не даёт окончательного ответа. Абсурд не находится только в человеке или только в мире: он возникает в их отношении. Поэтому его нельзя устранить простой теорией или верой в готовый порядок.'},
    {title:'«Посторонний» показывает героя, не принимающего общественные эмоциональные формулы', proof:'Мерсо не демонстрирует ожидаемую скорбь на похоронах матери и не пытается представить себя нравственно лучше, чем он есть. Он говорит о жаре, усталости и телесных ощущениях, а не о возвышенных чувствах. Общество воспринимает такую честность как угрозу.'},
    {title:'Суд над Мерсо создаёт удобную моральную версию его жизни', proof:'Обвинение связывает поведение героя на похоронах с убийством и строит цельный образ безнравственного человека. Реальные обстоятельства преступления подчиняются заранее выбранной интерпретации. Суд осуждает Мерсо не только за поступок, но и за отказ подтверждать общественные нормы чувствования.'},
    {title:'Финал «Постороннего» показывает принятие абсурда', proof:'Ожидая казни, Мерсо отказывается от надежды на высшее оправдание и принимает безразличие мира. Это не приносит внешнего спасения, но освобождает его от необходимости притворяться. Герой впервые ощущает полноту собственного существования.'},
    {title:'«Чума» переводит философию абсурда в этику совместного действия', proof:'Доктор Риэ не знает высшего смысла эпидемии и не уверен в окончательной победе. Тем не менее он лечит людей и организует сопротивление болезни. Нравственность определяется не гарантией успеха, а отказом мириться с чужим страданием.'},
    {title:'Бунт у Камю утверждает общую человеческую меру', proof:'Человек говорит злу «нет» не только ради себя, но и ради ценности, которую признаёт общей для всех. Такое сопротивление не должно превращаться в оправдание нового насилия. Поэтому Камю противопоставляет солидарный бунт и революционную идеологию, которая приносит конкретного человека в жертву будущему.'},
    {title:'Сартр и Камю предлагают разные ответы на отсутствие готового смысла', proof:'Сартр подчёркивает радикальную свободу, выбор и ответственность личности за себя и историю. Камю обращается к абсурду, пределам действия, мере и солидарности. Их объединяет отказ от пассивного самооправдания, но различает понимание политического действия и допустимых средств.'}
  ],
  92: [
    {title:'Британский постмодернистский роман переосмысливает национальную литературную традицию', proof:'Писатели активно используют исторический роман, биографию, викторианскую прозу, готику, детектив и научную фантастику. Традиция не отвергается, а превращается в материал для цитирования, стилизации, пародии и нового толкования.'},
    {title:'История изображается как совокупность текстов и конкурирующих версий', proof:'Прошлое доступно только через документы, мемуары, книги, городские пространства и более поздние интерпретации. Роман не утверждает, что способен полностью восстановить событие. Он показывает, как исторический рассказ создаётся и зависит от языка и позиции рассказчика.'},
    {title:'Питер Акройд создаёт образ Лондона как многослойного культурного текста', proof:'В его романах город хранит следы разных эпох, авторов, преступлений и литературных сюжетов. Одни и те же мотивы повторяются через столетия, а современный герой оказывается включён в старую историю. Лондон становится не фоном, а носителем коллективной памяти.'},
    {title:'В прозе Акройда документальность соединяется с вымыслом', proof:'Реальные писатели, исторические обстоятельства и стилизованные документы соседствуют с вымышленными эпизодами. Читатель не всегда может провести чёткую границу между архивным источником и авторской мистификацией. Тем самым ставится вопрос о повествовательной природе любой биографии и истории.'},
    {title:'Стилизация воспроизводит не только эпоху, но и способ её мышления', proof:'Акройд имитирует язык хроники, викторианского романа, детектива, биографии или научного исследования. Каждый стиль создаёт собственную модель реальности. Смена языков показывает, что прошлое нельзя отделить от форм, в которых оно было описано.'},
    {title:'Энтони Бёрджесс занимает переходное положение между модернизмом и постмодернизмом', proof:'Его нельзя без оговорки считать только представителем зрелого постмодернизма. В его прозе соединяются модернистский интерес к языку, сатирическая антиутопия, жанровая игра и постмодернистское смешение культурных кодов. Поэтому точнее говорить о переходной и гибридной позиции автора.'},
    {title:'«Заводной апельсин» исследует связь языка, насилия и свободы', proof:'Алекс рассказывает историю на вымышленном жаргоне надсат, сочетающем английскую основу и русские элементы. Читатель постепенно осваивает этот язык и оказывается внутри сознания героя. Речевая форма создаёт опасную близость к насилию, не отменяя его нравственной неприемлемости.'},
    {title:'Надсат защищает молодёжную среду и одновременно манипулирует восприятием читателя', proof:'Жаргон отделяет Алекса и его друзей от мира взрослых и делает преступления частью особого эстетизированного кода. Непривычные слова смягчают непосредственный ужас происходящего. Читатель вынужден самостоятельно возвращать словам их реальное содержание.'},
    {title:'Принудительное исправление уничтожает возможность нравственного выбора', proof:'После применения метода Людовико Алекс физически не способен совершать насилие. Однако он также теряет способность свободно выбрать добро. Государство превращает человека в безопасный механизм, а роман ставит вопрос: может ли поступок считаться нравственным, если у личности нет возможности поступить иначе.'},
    {title:'«Заводной апельсин» не оправдывает героя и не оправдывает государство', proof:'Алекс жесток и несёт ответственность за совершённое. Но государственная система отвечает на его насилие собственным насилием над сознанием. Роман не предлагает простого выбора между преступником и властью, а защищает сам принцип свободной воли.'},
    {title:'Британский постмодернистский роман смешивает жанры и культурные уровни', proof:'Историческая проза соединяется с детективом, философский роман — с фантастикой, классическая цитата — с рекламой, жаргоном и массовой культурой. Смешение разрушает устойчивую иерархию жанров и позволяет одному произведению обращаться к разным читательским ожиданиям.'},
    {title:'Ненадёжный рассказчик становится важным средством поэтики', proof:'Герой может ошибаться, скрывать сведения, искажать прошлое или оправдывать себя. Читатель не получает окончательно авторитетной версии и должен учитывать ограниченность голоса, через который воспринимает события.'},
    {title:'Джулиан Барнс и Грэм Свифт исследуют ненадёжность памяти и исторического знания', proof:'В их романах частное воспоминание не совпадает с объективной хроникой. Герой пересматривает прошлое, обнаруживает пробелы и понимает, что память создаёт связную историю задним числом. История раскрывается как предмет личной и нравственной ответственности.'},
    {title:'Мартин Эмис и Салман Рушди расширяют проблематику британского постмодернизма', proof:'Мартин Эмис обращается к массовой культуре, деньгам, насилию и нравственной деградации современного общества. Рушди соединяет историю, миф, фантастику и опыт миграции, показывая гибридную идентичность человека, существующего между несколькими культурами.'},
    {title:'Формальная игра не исключает этической серьёзности', proof:'Британский постмодернистский роман обсуждает насилие, память, колониальное прошлое, свободу и власть языка. Игра и стилизация не отменяют реальность, а показывают сложность её осмысления.'}
  ],
  98: [
    {title:'«Парфюмер» сочетает постмодернистскую игру с традицией исторического и романтического романа', proof:'Произведение использует форму биографии необыкновенного героя, исторический материал XVIII века, мотив исключительного гения и подробное описание ремесла. Одновременно эти традиции иронически переосмысливаются: гениальный художник оказывается лишённым человечности убийцей.'},
    {title:'Определение романа как постмодернистского допустимо, но не исчерпывает его поэтику', proof:'В тексте присутствуют жанровая игра, стилизация, пародийное переосмысление мифа о гении и соединение массового сюжета с философской проблематикой. Однако роман также сохраняет черты притчи, исторической прозы, готики и романтической истории об исключительном художнике.'},
    {title:'Историческая достоверность соединяется с гротеском', proof:'Париж XVIII века подробно изображён через ремесло, торговлю, общественную иерархию и бытовые детали. Одновременно мир представлен через гиперболизированное зловоние, уродство и физическую материальность. История становится одновременно убедительной и нарочито деформированной.'},
    {title:'Запах является главным принципом организации художественного мира', proof:'Гренуй почти не интересуется внешним обликом, речью или нравственными качествами людей. Он воспринимает мир через запахи и способен различать их мельчайшие оттенки. Читателю предлагается необычная сенсорная перспектива, меняющая привычную иерархию чувств.'},
    {title:'Отсутствие собственного запаха символизирует отсутствие устойчивой человеческой идентичности', proof:'Окружающие бессознательно ощущают в Гренуе нечто пугающее, потому что он не обладает индивидуальным запахом. Он способен воспринимать и присваивать мир, но сам не вступает в естественную взаимность с другими людьми. Его невидимость выражает внутреннюю пустоту.'},
    {title:'Гренуй пародийно переосмысливает романтический образ гения', proof:'Он обладает уникальным даром, презирает толпу и посвящает жизнь созданию совершенного произведения. Но его искусство основано на убийстве и превращении человека в материал. Возвышенный миф о художнике доводится до преступного и гротескного предела.'},
    {title:'Искусство у Гренуя становится не формой познания, а технологией власти', proof:'Герой хочет создать аромат, который заставит людей любить его. Он не стремится к взаимности и не выражает внутренний мир. Его произведение программирует чужую реакцию и лишает толпу способности к самостоятельной оценке.'},
    {title:'Убийства девушек показывают превращение личности в эстетическое сырьё', proof:'Гренуй не воспринимает жертв как самостоятельных людей. Он сохраняет их запах так же, как парфюмер извлекает эссенцию из цветка. Эстетическая цель полностью уничтожает нравственную границу между творчеством и преступлением.'},
    {title:'Телесность разрушает декоративный образ прошлого', proof:'Город изображён через запахи рынков, тел, нечистот, мастерских и разлагающейся материи. Историческая эпоха лишается музейной красоты. Такая материальность одновременно создаёт достоверность и пародирует традиционную идеализацию XVIII века.'},
    {title:'Сцена казни раскрывает управляемость массового сознания', proof:'Под воздействием аромата толпа перестаёт видеть в Гренуе убийцу и воспринимает его как прекрасное и невинное существо. Суд, память и мораль мгновенно уступают чувственному внушению. Общество оказывается готовым отказаться от истины ради сильного впечатления.'},
    {title:'Абсолютная власть над людьми не приносит герою подлинной любви', proof:'Гренуй понимает, что толпа любит не его самого, а созданный им запах. Полный успех только подтверждает, что собственной личности, способной вступить в отношения с другим, у него нет. Триумф превращается в окончательное доказательство одиночества.'},
    {title:'Финал соединяет самоуничтожение, потребление и последнюю манипуляцию', proof:'Гренуй обливается духами, после чего толпа в состоянии восторженной любви разрывает и съедает его. Герой уничтожает себя собственным шедевром. Любовь, созданная искусственно, принимает форму буквального потребления.'},
    {title:'Авторская позиция сохраняет двойственность', proof:'Рассказчик подробно и увлекательно описывает талант Гренуя, заставляя читателя следить за его успехами. Одновременно преступления героя нравственно отвратительны. Эстетическое восхищение мастерством вступает в конфликт с этической оценкой.'}
  ],
  99: [
    {title:'Интеллектуальная проза превращает философскую проблему в художественный сюжет', proof:'Борхес и Кортасар исследуют время, бесконечность, случайность, язык, авторство и границы реальности не в форме отвлечённого трактата, а через рассказ, фантастическую ситуацию, композиционную игру и парадокс.'},
    {title:'Интеллектуальная фантастика Борхеса и Кортасара отличается от классического магического реализма', proof:'Магический реализм чаще соединяет миф, историю, народное сознание и повседневную жизнь целого сообщества. У Борхеса фантастическое прежде всего воплощает философскую конструкцию, а у Кортасара нарушает устойчивость индивидуального восприятия и привычной реальности. Поэтому их поэтику точнее связывать с интеллектуальной и экспериментальной фантастикой.'},
    {title:'Борхес создаёт короткий текст с масштабом воображаемой энциклопедии', proof:'Его рассказы могут имитировать рецензию, научную статью, биографию, комментарий к несуществующей книге или историческое свидетельство. Небольшой объём открывает огромное пространство вымышленных источников и философских предположений.'},
    {title:'Лабиринт становится моделью мира и человеческого познания', proof:'Лабиринт у Борхеса может быть зданием, книгой, временем, системой зеркал или сетью решений. Человек ищет центр и окончательный смысл, но сам процесс поиска создаёт новые ответвления. Познание не завершает лабиринт, а продолжает его.'},
    {title:'«Вавилонская библиотека» изображает Вселенную как бесконечный текст', proof:'Библиотека содержит все возможные сочетания знаков, а значит, все истинные и ложные книги. Полнота информации не даёт людям знания, потому что они не способны найти и распознать нужный текст. Бесконечность информации становится формой недоступности смысла.'},
    {title:'«Сад расходящихся тропок» предлагает модель множественного времени', proof:'В книге Цюй Пэна каждое возможное решение осуществляется и создаёт отдельную ветвь будущего. Время перестаёт быть единственной линией. Детективный и шпионский сюжет становится художественным воплощением философской идеи параллельных возможностей.'},
    {title:'Борхес ставит под сомнение устойчивость авторства', proof:'В рассказе «Пьер Менар, автор “Дон Кихота”» словесно одинаковые фрагменты получают другой смысл, потому что созданы в иную эпоху. Значение определяется не только текстом, но и культурным контекстом. Автор перестаёт быть единственным и окончательным источником смысла.'},
    {title:'Кортасар вводит фантастическое внутрь бытовой реальности', proof:'Необычное не объясняется и не отделяется от повседневного мира. Комната может быть захвачена неизвестной силой, привычный маршрут — открыть иной уровень реальности, а сознание — перейти в другое тело. Фантастическое обнаруживает хрупкость нормального порядка.'},
    {title:'«Захваченный дом» строится на принципиально неназванной угрозе', proof:'Брат и сестра постепенно оставляют комнаты, занятые неизвестным присутствием. Рассказ не сообщает, что именно вытесняет героев. Благодаря этому событие допускает психологическое, социальное, историческое и метафизическое толкование.'},
    ...
    {title:'«Игра в классики» превращает композицию в форму читательского выбора', proof:'Роман можно читать последовательно или двигаться по предложенной автором схеме между главами. Единственный обязательный порядок отсутствует. Читатель становится участником построения произведения.'},
    {title:'Игра у Кортасара связана с поиском иной формы существования', proof:'Герои пытаются выйти за пределы привычного сознания через любовь, музыку, случай, детскую игру и нарушение логики. Но достижение целостности постоянно откладывается. Игра одновременно освобождает и обнаруживает невозможность окончательного выхода.'},
    {title:'Джаз становится моделью художественной импровизации', proof:'В прозе Кортасара эпизоды, голоса и мотивы могут соединяться как музыкальные импровизации. Возврат темы не означает точного повторения: каждый раз она получает новое развитие. Такая композиция противопоставлена жёстко заданной последовательности.'},
    {title:'Борхеса и Кортасара объединяет активная роль читателя', proof:'У Борхеса читатель должен распознавать философские парадоксы, вымышленные источники и интертекстуальные связи. У Кортасара — выдерживать неопределённость и самостоятельно выбирать маршрут чтения. Произведение не сообщает готовую истину, а создаёт интеллектуальную задачу.'}
  ]
};
